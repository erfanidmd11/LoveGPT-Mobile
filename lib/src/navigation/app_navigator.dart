...
import 'package:lovegpt_mobileapp/src/screens/dashboard/dashboard_screen.dart'; // ✅ fixed path
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.otp: (context) => const OTPVerificationScreen(phone: ''), // dynamic handling
        ...
        AppRoutes.dashboard: (context) => const DashboardScreen(), // ✅ now resolvable

...
import 'package:lovegpt_mobileapp/src/dashboard/dashboard_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.otp: (context) => const OTPVerificationScreen(phone: ''), // Pass phone and confirmation dynamically
